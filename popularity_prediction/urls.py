"""popularity_prediction  URL Configuration
...
from popularity_prediction  import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Popularity_Type/$', remoteuser.Predict_Popularity_Type, name="Predict_Popularity_Type"),
    ...
    url(r'^Find_Popularity_Type_Ratio/$', serviceprovider.Find_Popularity_Type_Ratio, name="Find_Popularity_Type_Ratio"),
    url(r'^Train_Test_DataSets/$', serviceprovider.Train_Test_DataSets, name="Train_Test_DataSets"),
    url(r'^View_Popularity_Predicted_Type/$', serviceprovider.View_Popularity_Predicted_Type, name="View_Popularity_Predicted_Type"),
